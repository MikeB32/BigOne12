...
public class Tab11 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
           View v = inflater.inflate(R.layout.tab11, container, false);
        ImageView imageView = (ImageView) v.findViewById(R.id.img11);
        ...
        DbResponse response = db.getDataforTab11();
        TextView textView = (TextView)v.findViewById(R.id.txt13);
