...
public class Tab10 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.tab10, container, false);
        ImageView imageView = (ImageView) v.findViewById(R.id.img10);
       ...
       DataBaseHelper db = new DataBaseHelper(getActivity());
        DbResponse response = db.getDataforTab10();
        TextView textView = (TextView)v.findViewById(R.id.txt12);
