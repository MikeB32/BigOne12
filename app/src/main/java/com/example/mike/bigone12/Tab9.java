...
public class Tab9 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.tab9, container, false);
        ImageView imageView = (ImageView) v.findViewById(R.id.img9);
        ...
        DbResponse response = db.getDataforTab9();
        TextView textView = (TextView)v.findViewById(R.id.txt11);
